    ...
    return (
        <section className='w-3/5 mx-auto my-16'>
            ...
            <div className='flex sm:flex-col w-full lg:flex-row justify-center items-center mx-auto flex-wrap gap-16 my-16'>
                <div className='flex flex-row items-center shadow-2xl bg-gray-100 p-8 sm:w-96 md:w-2/5'>
                    <img src={reviewOne} alt="reviewerOne" className='w-24 h-20 rounded-full object-cover' />
                    <div className='flex flex-col ml-4'>
                        <p className='italic text-sm'>“I never knew what to do with those random pantry items. Thanks to this site, I've discovered incredible recipes that make every ingredient count.”</p>
                ...
                <div className='flex flex-row items-center shadow-2xl bg-gray-100 p-8 sm:w-96 md:w-2/5'>
                    ...
                    <div className='flex flex-col ml-4'>
                        <p className='italic text-sm'>“This platform has revolutionized my cooking. I can now use up all those odd ingredients I used to ignore.”</p>
                ...
                <div className='flex flex-row items-center shadow-2xl bg-gray-100 p-8 sm:w-96 md:w-2/5'>
                    ...
                    <div className='flex flex-col ml-4'>
                        <p className='italic text-sm'>“I was always left wondering what to do with my leftover ingredients. This website has made cooking with what I have so easy and fun.”</p>
                ...
                <div className='flex flex-row items-center shadow-2xl bg-gray-100 p-8 sm:w-96 md:w-2/5'>
                    ...
                    <div className='flex flex-col ml-4'>
                        <p className='italic text-sm'>“I've turned my kitchen into a playground of creativity, all thanks to this amazing tool. No more wasted ingredients!”</p>
